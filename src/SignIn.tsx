    ...
    return (
        <div className="h-screen bg-sky-950 py-12">
            ...
            <div className='mt-auto pb-4'>
                <Button variant="contained" startIcon={<SendIcon />}><a href='https://st-msg-app.auth.us-east-2.amazoncognito.com/login?client_id=6lk6tvff1cof0k2juf8s4rk93r&response_type=code&scope=email+openid+phone&redirect_uri=https%3A%2F%2Fmaster.d3s8cuax6od5me.amplifyapp.com%2Fappv2'>Sign In</a></Button>
            </div>
        </div>
    );
}
